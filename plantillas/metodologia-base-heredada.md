# compliance-cl — base de conocimiento (contenido original íntegro, movido 2026-07-12)
...
- **DPO** (Arts. 49-50 Ley 19.628 modificada): voluntario para todo responsable, público o privado, sin
  excepción por tipo de organismo ni por escala de tratamiento — obligatorio solo si se adopta y
  certifica el MPI del Art. 49. Si un órgano público lo designa, debe ser funcionario de la dotación
  vigente (Art. 7 inciso 2° Reglamento MPI + Art. quinto transitorio Ley 21.719, agregado por Ley
  21.806). En micro/pyme privada lo puede asumir el dueño → dar el resultado.
