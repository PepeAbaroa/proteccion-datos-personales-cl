...
## 1. Aviso corto (en el punto de captura, junto al formulario)
> Tus datos ([qué datos: ej. nombre, correo, teléfono]) los trata [RAZÓN SOCIAL] para [finalidad
> concreta]. Puedes ejercer tus derechos en [CORREO]. Más detalles en nuestra
> [Política de Privacidad](URL).

## 2. Consentimiento (checkbox, NO premarcado)
> ☐ Acepto que [RAZÓN SOCIAL] trate mis datos para [finalidad específica], según su
> [Política de Privacidad](URL).
...
## 4. Revocación
Incluye siempre una vía simple para retirar el consentimiento (link "darme de baja" en cada correo, o
botón en la cuenta). Retirar el consentimiento es tan fácil como darlo.

## 5. Registro del consentimiento (prueba)
Guarda por cada titular: qué aceptó, cuándo, cómo (IP/timestamp), y la versión de la política vigente.
La **carga de la prueba del consentimiento es del responsable** (Art. 12).
